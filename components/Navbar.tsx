      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center px-4">
        ...
        <div className="relative bg-surface rounded-[2rem] p-8 w-full max-w-sm shadow-2xl text-center border border-border">
          ...
          <p className="text-muted font-bold text-xs uppercase tracking-wide leading-relaxed mb-8">
            ...
            <span className="text-foreground select-all">{registeredEmail}</span>.
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center px-4">
      ...
      <div className="relative bg-surface rounded-[2rem] p-8 w-full max-w-sm shadow-2xl border border-border text-foreground">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {error && (
            <p className="text-critical text-xs font-bold uppercase tracking-wide">
              {error}
            </p>
          )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-foreground text-background py-4 rounded-2xl font-black uppercase tracking-widest text-sm transition-all duration-300 hover:opacity-90 disabled:opacity-50"
          >
            {loading ? (
        ...
        <p className="text-center text-xs text-muted mt-6">
          ...
          <button
            ...
            className="font-black text-foreground underline ml-1"
          >
        ...
        <p className="text-center text-xs mt-4">
          <button
            onClick={onClose}
            className="font-bold text-subtle hover:text-muted underline transition-colors"
          >
            Continue as guest
          </button>
        </p>
